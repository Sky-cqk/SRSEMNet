...
class UpsampleBlock(nn.Module):
    def __init__(self,
                 n_channels, scale=2, multi_scale=1,
                 group=1):
...
class Net(nn.Module):
    def __init__(self,**kwargs,):
        ...
        self.conv5 =nn.Sequential(nn.Conv2d(64,3,3,1,1,groups=1,bias=False))
    ...
    def forward(self,x,scale):
        ...
        x4=self.conv4(x3)
        x5=x4+x1
        x6=self.upsample(x5,scale=scale)
        x7=self.conv5(x6)
        out=self.add_mean(x7)
        return out
