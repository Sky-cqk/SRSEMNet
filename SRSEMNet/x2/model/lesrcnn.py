...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        b1 = self.b1(o0)#[64,64,512,384]
        c1 = torch.cat([c0, b1], dim=1)#[64,128,512,384]
        o1 = self.c1(c1)#[64,64,512,384]
        
        b2 = self.b1(o1)#[64,64,512,384]
        c2 = torch.cat([c1, b2], dim=1)#[64,192,512,384]
        o2 = self.c2(c2)#[64,64,512,384]
        
        b3 = self.b1(o2)#[64,64,512,384]
        c3 = torch.cat([c2, b3], dim=1)#[64,256,512,384]
        o3 = self.c3(c3)#[64,64,512,384]

        return o3#[64,64,512,384]
...
class Net(nn.Module):
    ...
    def forward(self, x, scale):
        #print '-------dfd'
        x = self.sub_mean(x)#[64,3,512,384]
        c0 = x
        x1 = self.conv1(x)#[64,64,512,384]
        x1_1 = self.ReLU(x1)#[64,64,512,384]
        x2 = self.conv2(x1_1)#[64,64,512,384]
        x3 = self.conv3(x2)#[64,64,512,384]
        x2_3 = x1+x3#[64,64,512,384]
        x2_4 = self.ReLU(x2_3)#[64,64,512,384]
        x4 = self.conv4(x2_4)#[64,64,512,384]
        x5 = self.conv5(x4)#[64,64,512,384]
        x3_5 = x2_3 + x5 
        x3_6 = self.ReLU(x3_5)
        x6 = self.conv6(x3_6)
        x7 = self.conv7(x6)
